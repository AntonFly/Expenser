...
public interface MonthResultService {
    Collection<MonthResultResponse> findAll();

    @Transactional(rollbackFor = Exception.class)
    MonthResultResponse createMonthResult(MonthResultCreate dto) throws UserNotFoundException, MonthResultBadRequestException;

    @Transactional(rollbackFor = Exception.class)
    MonthResultResponse updateMonthResult(MonthResultUpdate dto) throws MonthResultNotFoundException,MonthResultBadRequestException,UserNotFoundException;
